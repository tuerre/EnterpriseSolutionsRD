...
export function Inicio() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-black gradient-text mb-2 tracking-tight">Inicio</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card
          ...
          action={
            <button onClick={() => navigate('/productos')} className="text-sm text-[#d946ef] hover:text-[#7c3aed] font-bold transition-colors duration-300">
              Ver todas →
            </button>
          }
        >
